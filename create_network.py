...
def train_network(args):
    ...
    for i in range(0,args.num_users):
        selected_train_dataset = get_user_data(args,num_classes,trainset,class_indices,my_model,criterion,num_samples_per_class)
...
def test_network(args):
    ...
    for i in range(0,args.num_users):
            selected_test_dataset = get_user_data(args,num_classes,testset,class_indices,my_model,criterion,num_samples_per_class)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_dir",type=str,default=f"/content/Robust-Evaluation/train")
